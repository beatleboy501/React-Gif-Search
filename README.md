...
Import required React Bootstrap components within ```src/Home.jsx``` file or your custom component files:
...
4. Add `// @flow` to any files you want to type check (for example, to `src/Home.jsx`).
